...
.btn-action { padding: 0.25rem 0.75rem; border: none; border-radius: 15px; font-size: 0.8rem; font-weight: 600; cursor: pointer; text-transform: uppercase; letter-spacing: 0.5px; transition: all 0.3s ease; }
...
.pagination a, .pagination span { padding: 0.75rem 1rem; border-radius: 10px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; }
...
.pagination .current { background: #C9A961; color: white; border: 1px solid #C9A961; }
@media (max-width: 768px) { .filters { flex-direction: column; align-items: stretch; } .filter-actions { justify-content: center; } .reservation-actions { flex-direction: column; } }
</style>
